...
csv_path = os.path.join(PATHS.METRICS_DIR, "confusion_matrices_tiles.csv")
...
agg_path = os.path.join(PATHS.METRICS_DIR, "confusion_matrix_aggregate.png")
agg_fig.savefig(agg_path, dpi=150)
...
grid_path = os.path.join(PATHS.METRICS_DIR, "confusion_matrix_tiles_grid.png")
...
fig.tight_layout()
err_path = os.path.join(PATHS.METRICS_DIR, "confusion_matrix_tile_errors.png")
